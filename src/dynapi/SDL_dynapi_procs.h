...
SDL_DYNAPI_PROC(SDL_RemapperContext*,SDL_CreateRemapper,(void),(),return)
SDL_DYNAPI_PROC(void,SDL_DestroyRemapper,(SDL_RemapperContext *a),(a),)
SDL_DYNAPI_PROC(int,SDL_SetRemapperProfile,(SDL_RemapperContext *a, SDL_JoystickID b, const SDL_RemapperProfile *c),(a,b,c),return)
SDL_DYNAPI_PROC(int,SDL_SetRemapperMouseProfile,(SDL_RemapperContext *a, SDL_MouseID b, const SDL_RemapperProfile *c),(a,b,c),return)
SDL_DYNAPI_PROC(int,SDL_SetRemapperKeyboardProfile,(SDL_RemapperContext *a, SDL_KeyboardID b, const SDL_RemapperProfile *c),(a,b,c),return)
SDL_DYNAPI_PROC(int,SDL_ProcessRemappedEvent,(SDL_RemapperContext *a, const SDL_Event *b, SDL_Event *c, int d),(a,b,c,d),return)
SDL_DYNAPI_PROC(bool,SDL_PollRemappedEvent,(SDL_RemapperContext *a, SDL_Event *b),(a,b),return)
SDL_DYNAPI_PROC(int,SDL_ShowGamepadRemappingWindow,(SDL_RemapperContext *a, SDL_JoystickID b, SDL_Renderer *c),(a,b,c),return)
SDL_DYNAPI_PROC(int,SDL_EditDeviceProfile,(SDL_RemapperContext *a, SDL_RemapperDeviceType b, SDL_Renderer *c, const char *d),(a,b,c,d),return)
SDL_DYNAPI_PROC(int,SDL_EditGamepadProfile,(SDL_RemapperContext *a, SDL_JoystickID b, SDL_Renderer *c, const char *d),(a,b,c,d),return)
SDL_DYNAPI_PROC(int,SDL_OpenDeviceProfilePage,(SDL_RemapperContext *a, SDL_RemapperDeviceType b, SDL_Renderer *c, const char *d),(a,b,c,d),return)
SDL_DYNAPI_PROC(void,SDL_GetDefaultRemapperUIConfig,(SDL_RemapperUIConfig *a),(a),)
SDL_DYNAPI_PROC(void,SDL_SetRemapperUIConfig,(const SDL_RemapperUIConfig *a),(a),)
SDL_DYNAPI_PROC(const SDL_RemapperUIConfig*,SDL_GetRemapperUIConfig,(void),(),return)
SDL_DYNAPI_PROC(const SDL_RemapperProfile*,SDL_GetRemapperProfile,(SDL_RemapperContext *a, SDL_JoystickID b),(a,b),return)
SDL_DYNAPI_PROC(const char*,SDL_GetRemapperProfileName,(SDL_RemapperContext *a, SDL_JoystickID b),(a,b),return)
SDL_DYNAPI_PROC(const SDL_RemapperMapping*,SDL_GetRemapperButtonMapping,(SDL_RemapperContext *a, SDL_JoystickID b, SDL_GamepadButton c),(a,b,c),return)
SDL_DYNAPI_PROC(const SDL_RemapperMapping*,SDL_GetRemapperAxisMapping,(SDL_RemapperContext *a, SDL_JoystickID b, SDL_GamepadAxis c),(a,b,c),return)
SDL_DYNAPI_PROC(const SDL_RemapperStickMapping*,SDL_GetRemapperStickMapping,(SDL_RemapperContext *a, SDL_JoystickID b, SDL_GamepadAxis c),(a,b,c),return)
SDL_DYNAPI_PROC(int,SDL_GetRemapperPlayerIndex,(SDL_RemapperContext *a, SDL_JoystickID b),(a,b),return)
SDL_DYNAPI_PROC(char*,SDL_GetRemapperActionDescription,(const SDL_RemapperAction *a),(a),return)
SDL_DYNAPI_PROC(char*,SDL_GetRemapperStickMappingDescription,(const SDL_RemapperStickMapping *a),(a),return)
SDL_DYNAPI_PROC(SDL_RemapperProfile*,SDL_CreateGamepadPassthroughProfile,(SDL_JoystickID a),(a),return)
SDL_DYNAPI_PROC(SDL_RemapperStickMapping*,SDL_CreateMouseStickMapping,(float a),(a),return)
SDL_DYNAPI_PROC(SDL_RemapperStickMapping*,SDL_CreateKeyboardStickMapping,(bool a),(a),return)
SDL_DYNAPI_PROC(void,SDL_FreeStickMapping,(SDL_RemapperStickMapping *a),(a),)
SDL_DYNAPI_PROC(SDL_RemapperUI*,SDL_CreateRemapperUI,(SDL_RemapperContext *a, SDL_JoystickID b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_RemapperUI_HandleEvent,(SDL_RemapperUI *a, const SDL_Event *b),(a,b),return)
SDL_DYNAPI_PROC(void,SDL_RemapperUI_Draw,(SDL_RemapperUI *a, SDL_Renderer *b),(a,b),)
SDL_DYNAPI_PROC(bool,SDL_RemapperUI_ShouldClose,(SDL_RemapperUI *a),(a),return)
SDL_DYNAPI_PROC(void,SDL_DestroyRemapperUI,(SDL_RemapperUI *a),(a),)
SDL_DYNAPI_PROC(int,SDL_SaveRemapperProfile,(const SDL_RemapperProfile *a, const char *b),(a,b),return)
SDL_DYNAPI_PROC(SDL_RemapperProfile*,SDL_LoadRemapperProfile,(const char *a),(a),return)
SDL_DYNAPI_PROC(void,SDL_FreeRemapperProfile,(SDL_RemapperProfile *a),(a),)
SDL_DYNAPI_PROC(const char*,SDL_GetRemapperProfilesPath,(void),(),return)
SDL_DYNAPI_PROC(char**,SDL_GetRemapperProfileList,(int *a),(a),return)
SDL_DYNAPI_PROC(void,SDL_FreeRemapperProfileList,(char **a, int b),(a,b),)
SDL_DYNAPI_PROC(SDL_RemapperProfile*,SDL_LoadRemapperProfileByName,(const char *a),(a),return)
SDL_DYNAPI_PROC(bool,SDL_RemapperProfileExists,(const char *a),(a),return)
SDL_DYNAPI_PROC(int,SDL_DeleteRemapperProfileByName,(const char *a),(a),return)
SDL_DYNAPI_PROC(int,SDL_CreateRemapperProfileWithName,(SDL_JoystickID a, const char *b),(a,b),return)
SDL_DYNAPI_PROC(int,SDL_ApplyRemapperProfileByName,(SDL_RemapperContext *a, SDL_JoystickID b, const char *c),(a,b,c),return)
